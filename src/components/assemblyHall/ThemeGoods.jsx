...
import { listBanner,actionScene,actionTheme,addOrUpdateBanner,themeList } from '../../api/assemblyHall/index';
...
class AssBanner extends React.Component {
    ...
    initData() {
        ...
        this.setState({
            ...
            themeList(this.state.query).then((res) => {
                that.setState({
                    loading: false
                }, () => {
    ...
    render() {
        ...
        return (
            <div className="gutter-example">
                <BreadcrumbCustom first="组合会场" second="主题区" />
