                        ...
                        <Form {...formItemLayout} onSubmit={this.handleSubmit} labelAlign={'right'}>
                            ...
                            <FormItem label="关联专场管理">
                                {getFieldDecorator('featuredId', {
                                    ...
                                    <Select disabled={this.state.disabled} labelInValue onChange={this.handleSelectPageV} style={{ width: '35rem' }} >

                                        {this.state.featuredList.map(item => (
                                            <Option value={item.featuredId} >{item.tipTitle}</Option>
                                        ))}
